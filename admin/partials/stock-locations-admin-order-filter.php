...
<select name="<?php esc_attr_e($this->plugin_name . "-location") ?>" class=""
    data-placeholder="<?php esc_attr_e('Filter by store', $this->plugin_name); ?>"
    id="<?php esc_attr_e($this->plugin_name . "-location") ?>">
    ...
    <?php
        ...
        $current = filter_input(INPUT_GET, $this->plugin_name . "-location", FILTER_VALIDATE_INT);
